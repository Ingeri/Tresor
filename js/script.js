...
document.addEventListener("DOMContentLoaded", function () {
  ...
  skills.forEach((skill) => {
    let width = skill.classList.contains("html")
      ? "100%"
      : skill.classList.contains("css")
      ? "85%"
      : skill.classList.contains("js")
      ? "75%"
      : skill.classList.contains("php")
      ? "60%"
      : "0%";
...
function moveSlider() {
  ...
  if (screenWidth >= 900) {
    ...
    // Treat medium and small screens the same
...
function filterProjects(category) {
  ...
  setTimeout(() => {
    ...
    let filteredProjects = document.querySelectorAll(
